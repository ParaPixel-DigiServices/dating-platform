...
export interface OtpFlowRef {
  goBack: () => void;
}

export const OtpFlow = forwardRef<OtpFlowRef, Props>(({ onSuccess, onBack }, ref) => {
  ...
  // Destructure Theme
  const casualTheme = theme.onboarding;
          ...
          >
            ...
            <View style={styles.stepContainer}>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Text style={[styles.primaryButtonText, { color: "#0D0A07" }]}>
                    {phoneAuthStore.isVerifying ? "Sending..." : "Continue"}
                  </Text>
                  {!phoneAuthStore.isVerifying && (
                    <Feather name="arrow-right" size={20} color="#0D0A07" style={styles.buttonIcon} />
                  )}
                </TouchableOpacity>
              </View>
            </Animated.View>
            ...
            >
              <View style={styles.headerSection}>
                ...
                <Text style={[styles.subtitle, { color: casualTheme.textSecondary }]}>
                  ...
                  <Text style={{ color: casualTheme.textPrimary }}>{phoneAuthStore.phoneNumber}</Text>
                </Text>
              </View>
          ...
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContent, { backgroundColor: casualTheme.secondary }]}>
              ...
              <TouchableOpacity 
                ...
                activeOpacity={0.8}
              >
                <Text style={[styles.modalButtonText, { color: "#0D0A07" }]}>Got it</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
...
const styles = StyleSheet.create({
  ...
  countryCodeBox: {
    ...
    borderWidth: 1,
    borderColor: "rgba(229,179,153,0.18)", 
  },
  countryCodeText: {
    fontSize: 16,
    fontWeight: "500",
