...
export default function DetailsScreen() {
  ...
  const casualTheme = theme.onboarding; // Updated: warm champagne theme
  ...
  const onSubmit = async (data: DetailsFormData) => {
    try {
      ...
      showErrorToast(error?.message ?? "Failed to save details");
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      <ImageBackground source={BG_IMG} style={styles.bg} resizeMode="cover">
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          >
            {/* ── TOP BAR + PROGRESS ───────────────────────────── */}
            <OnboardingTopBar step={2} onBack={() => router.back()} />
            ...
            >
              ...
              <View style={styles.headerSection}>
                ...
                <View style={styles.heroIconContainer}>
                  ...
                  <Ionicons
                    name="heart"
                    size={20}
                    color={casualTheme.primaryLight}
                    style={styles.heroIconSmall}
                  />
                </View>

                <Text
                  style={[styles.title, { color: casualTheme.textPrimary }]}
                >
                  Tell us about{" "}
                  <Text style={{ color: casualTheme.primary }}>yourself</Text>
                </Text>
                <Text
                  style={[
                    styles.subtitle,
              ...
              <View style={styles.formContainer}>
                ...
                <View style={styles.inputWrapper}>
                  <Text
                    style={[styles.inputLabel, { color: casualTheme.primary }]}
                  >
                    FIRST NAME
                  </Text>
                  <Controller
                        ...
                        <View
                          style={[
                            ...
                            focusedInput === "firstName" && {
                              borderColor: casualTheme.primary,
                            },
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <TextInput
                          ...
                          style={[
                            styles.unifiedDobInput,
                            { flex: 1.5, color: casualTheme.textPrimary },
                          ]}
                          placeholder="YYYY"
                          placeholderTextColor={casualTheme.textSecondary}
                          keyboardType="number-pad"
              ...
              <View style={styles.footerSection}>
                ...
                >
                  <Text
                    style={[styles.primaryButtonText, { color: "#0D0A07" }]}
                  >
